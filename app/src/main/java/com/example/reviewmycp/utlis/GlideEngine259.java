...
public class GlideEngine259 implements ImageEngine {
    /**
     * 加载图片
     *
     * @param context
    ...
    private GlideEngine259() {
    }

    private static GlideEngine259 instance;

    public static GlideEngine259 createGlideEngine() {
        if (null == instance) {
            synchronized (GlideEngine259.class) {
                if (null == instance) {
                    instance = new GlideEngine259();
                }
            }
        }
        return instance;
